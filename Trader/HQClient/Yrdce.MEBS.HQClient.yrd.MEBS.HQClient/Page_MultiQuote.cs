	...
	internal class Page_MultiQuote : Page_Main
	{
		...
		private void checkCommCurprice()
		{
			while (!this.stopFlag)
			{
				...
				ProductDataVO[] curQuoteList;
				Monitor.Enter(curQuoteList = this.m_multiQuoteData.m_curQuoteList);
				try
				{
					if (this.m_multiQuoteData.m_curQuoteList.Length != 0)
					{
						...
						for (int i = 0; i < num; i++)
						{
							...
							{
								if (productDataVO.datahighlightTime == this.m_multiQuoteData.HighlightTime && !productDataVO.isDraw)
								{
									GDIDraw.XorRectangle(this.m_hqForm.M_Graphics, productDataVO.curPriceRectangle, SetInfo.RHColor.clPriceChange, this.m_hqForm.ScrollOffset);
		...
		private void paintQuoteData(Graphics g)
		{
			...
			try
			{
				...
				{
					if (this.buttonUtils.CurButtonName.StartsWith("Market"))
					{
					...
					{
						if (this.buttonUtils.CurButtonName.Equals("MyCommodity"))
						{
						...
						{
							if (this.buttonUtils.CurButtonName.StartsWith("MAC"))
							{
							...
							{
								if (this.buttonUtils.CurButtonName.StartsWith("C"))
								{
								...
								{
									if (this.buttonUtils.CurButtonName.StartsWith("Select"))
									{
							...
							for (int num13 = 0; num13 < this.m_strItems.Length; num13++)
							{
								if (num13 <= this.m_iStaticIndex || num13 >= this.iDynamicIndex)
								{
									...
									if (multiQuoteItemInfo != null)
									{
										...
										{
											if (this.m_strItems[num13].Equals("Name"))
											{
												string text6 = text5;
											...
											{
												if (this.m_strItems[num13].Equals("Code"))
												{
												...
												{
													if (this.m_strItems[num13].Equals("CurPrice"))
													{
													...
													{
														if (this.m_strItems[num13].Equals("Balance"))
														{
														...
														{
															if (this.m_strItems[num13].Equals("UpValue"))
															{
															...
															{
																if (this.m_strItems[num13].Equals("UpRate"))
																{
																...
																{
																	if (this.m_strItems[num13].Equals("YesterBalance"))
																	{
																	...
																	{
																		if (this.m_strItems[num13].Equals("OpenPrice"))
																		{
																		...
																		{
																			if (this.m_strItems[num13].Equals("BuyPrice"))
																			{
																			...
																			{
																				if (this.m_strItems[num13].Equals("SellPrice"))
																				{
																				...
																				{
																					if (this.m_strItems[num13].Equals("BuyAmount"))
																					{
																					...
																					{
																						if (this.m_strItems[num13].Equals("SellAmount"))
																						{
																						...
																						{
																							if (this.m_strItems[num13].Equals("HighPrice"))
																							{
																							...
																							{
																								if (this.m_strItems[num13].Equals("LowPrice"))
																								{
																								...
																								{
																									if (this.m_strItems[num13].Equals("TotalAmount"))
																									{
																									...
																									{
																										if (this.m_strItems[num13].Equals("TotalMoney"))
																										{
																										...
																										{
																											if (this.m_strItems[num13].Equals("ReverseCount"))
																											{
																											...
																											{
																												if (this.m_strItems[num13].Equals("CurAmount"))
																												{
																												...
																												{
																													if (this.m_strItems[num13].Equals("AmountRate"))
																													{
																													...
																													{
																														if (this.m_strItems[num13].Equals("ConsignRate"))
																														{
																															if (multiQuoteItemInfo.width - num12 < this.dataGap)
																															{
																																multiQuoteItemInfo.width += num12 - multiQuoteItemInfo.width + this.dataGap;
																														...
																														{
																															if (this.m_strItems[num13].Equals("Region"))
																															{
																															...
																															{
																																if (this.m_strItems[num13].Equals("Industry"))
																																{
																																	solidBrush.Color = Color.White;
																																	string text8 = "—";
																																	...
																																	{
																																		if (productDataVO2.industry != null)
																																		{
																																...
																																{
																																	if (this.m_strItems[num13].Equals("MarketName"))
																																	{
																																		string text9 = "--";
			...
			try
			{
				...
				if (e.Button == MouseButtons.Left)
				{
					...
					if (this.xScrollRect.Contains(num, num2) && !this.xScrollBarRect.Contains(num, num2))
					{
						...
						{
							if (num > this.xScrollRect.X + this.xScrollRect.Width - this.scrollButtonSize)
							{
							...
							else
							{
								...
								{
									if (num3 > this.xScrollRect.Width - 2 * this.scrollButtonSize - this.xScrollBarWidth / 2)
									{
										this.xChange = this.xMaxChaneg;
									}
									else
					...
					{
						if (this.yScrollRect.Contains(num, num2) && !this.yScrollBarRect.Contains(num, num2))
						{
							...
							{
								if (num2 > this.yScrollRect.Y + this.yScrollRect.Height - this.scrollButtonSize)
								{
								...
								else
								{
									...
									{
										if (num4 > this.yScrollRect.Height - 2 * this.scrollButtonSize - this.yScrollBarHeight / 2)
										{
											this.m_multiQuoteData.yChange = this.yMaxChaneg;
										}
										else
			...
			try
			{
				...
				if (hQClientForm.m_isMouseLeftButtonDown)
				{
					if (this.xScrollBarRect.Contains(hQClientForm.m_mouseBeforeMove))
					{
						...
						{
							if (this.xScrollBarRect.X < this.xScrollRect.X + this.scrollButtonSize)
							{
								this.xChange = 0;
							}
						}
						...
						if (this.iDynamicIndex != Math.Ceiling((double)this.xChange / this.xOnceMove + this.needShowCol))
						{
							if (Math.Ceiling((double)this.xChange / this.xOnceMove + this.needShowCol) <= this.m_iStaticIndex + 1)
							{
								this.iDynamicIndex = this.m_iStaticIndex + 1;
							}
							else
					...
					{
						if (this.yScrollBarRect.Contains(hQClientForm.m_mouseBeforeMove))
						{
							this.scrolXOrY = 2;
							...
							{
								if (this.yScrollBarRect.Y < this.yScrollRect.Y + this.scrollButtonSize)
								{
									this.m_multiQuoteData.yChange = 0;
								}
							}
				...
				else
				{
					...
					else
					{
						...
						else
						{
							...
							{
								if (name.Equals("AddUserCommodity"))
								{
									if (this.m_multiQuoteData.iHighlightIndex > 0 && this.m_multiQuoteData.iHighlightIndex <= this.m_multiQuoteData.m_curQuoteList.Length)
									{
								...
								{
									if (name.Equals("DelUserCommodity"))
									{
										if (this.m_multiQuoteData.iHighlightIndex > 0 && this.m_multiQuoteData.iHighlightIndex <= this.m_multiQuoteData.m_curQuoteList.Length)
										{
		...
		private void changeSortField(string strSortItem)
		{
			...
			{
				this.isDescend = (byte)((this.isDescend == 1) ? 0 : 1);
				this.m_multiQuoteData.iStart = 0;
			}
			else
			{
