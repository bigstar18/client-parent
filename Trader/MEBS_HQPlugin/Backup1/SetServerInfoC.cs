...
// Type: Gnnt.MEBS.HQClient.SetServerInfoC
...
namespace Gnnt.MEBS.HQClient
{
  public class SetServerInfoC : UserControl
  {
    ...
    private void LoadData()
    {
      ...
      XmlNode xmlNode1 = this.xnConfigInfo.SelectSingleNode("AllTelecomServer");
      if (xmlNode1 != null)
      {
      ...
      if (xmlNode1 == null)
        return;
      foreach (XmlNode xmlNode2 in xmlNode3.ChildNodes)
      {
        MoudelServerInfo moudelServerInfo = new MoudelServerInfo();
        XmlElement xmlElement = (XmlElement) xmlNode2;
        if (xmlElement.SelectSingleNode("ServerName") != null)
    ...
    public void Initialize()
    {
      ...
      groupBox1.Text = this.xnConfigInfo.SelectSingleNode("Text").InnerText;
    ...
    private void tbPort_KeyPress(object sender, KeyPressEventArgs e)
    {
      ...
      if (textBox.Text.Length != 0 && textBox.SelectedText.Length != textBox.Text.Length || (int) e.KeyChar != 48)
        return;
      int num = (int) MessageBox.Show("端口不能以0开始!");
      e.Handled = true;
    }
