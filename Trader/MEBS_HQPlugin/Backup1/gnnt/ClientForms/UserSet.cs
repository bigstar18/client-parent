...
// Type: Gnnt.MEBS.HQClient.gnnt.ClientForms.UserSet
...
namespace Gnnt.MEBS.HQClient.gnnt.ClientForms
{
  public class UserSet : Form
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.SuspendLayout();
      this.tabControlSet.Controls.Add((Control) this.setItems);
      this.tabControlSet.Controls.Add((Control) this.setOther);
      ...
      this.setItems.Controls.Add((Control) this.butDefault);
      this.setItems.Controls.Add((Control) this.butDown);
      this.setItems.Controls.Add((Control) this.butUp);
      this.setItems.Controls.Add((Control) this.lbCur);
      this.setItems.Controls.Add((Control) this.lUseable);
      this.setItems.Controls.Add((Control) this.butDelItem);
      this.setItems.Controls.Add((Control) this.butAddItem);
      this.setItems.Controls.Add((Control) this.lbCurrentItems);
      this.setItems.Controls.Add((Control) this.lbUseable);
      ...
      this.setOther.Controls.Add((Control) this.gbInfo);
      this.setOther.Controls.Add((Control) this.cbMultiQuoteStaticIndex);
      this.setOther.Controls.Add((Control) this.cbBuySell);
      this.setOther.Controls.Add((Control) this.labelMultiQuoteStaticIndex);
      this.setOther.Controls.Add((Control) this.labelBuySell);
      ...
      this.gbInfo.Controls.Add((Control) this.lbInfo);
      ...
      this.ClientSize = new Size(317, 312);
      this.Controls.Add((Control) this.buttonApply);
      this.Controls.Add((Control) this.buttonCancel);
      this.Controls.Add((Control) this.buttonConfirm);
      this.Controls.Add((Control) this.tabControlSet);
      ...
      this.Text = "UserSet";
      this.Load += new EventHandler(this.UserSet_Load);
    ...
    {
      string[] strArray1 = multiQuoteItems.Split(';');
      ArrayList arrayList1 = new ArrayList();
      for (int index = 0; index < strArray1.Length; ++index)
      {
        MultiQuoteItemInfo multiQuoteItemInfo = (MultiQuoteItemInfo) this.m_hqClient.m_htItemInfo[(object) strArray1[index]];
        if (multiQuoteItemInfo != null && multiQuoteItemInfo.name.Length != 0)
        {
          AddValue addValue = new AddValue(multiQuoteItemInfo.name, strArray1[index]);
          arrayList1.Add((object) addValue);
        }
      }
      if (arrayList1.Count != 0)
      {
        this.lbCurrentItems.DataSource = (object) arrayList1;
        this.lbCurrentItems.DisplayMember = "Display";
        this.lbCurrentItems.ValueMember = "Value";
      }
      else
      {
        this.lbCurrentItems.DisplayMember = (string) null;
        this.lbCurrentItems.ValueMember = (string) null;
      }
      ArrayList arrayList2 = new ArrayList();
      string[] strArray2 = this.m_hqClient.strAllItemName.Split(';');
      for (int index = 0; index < strArray2.Length; ++index)
      {
        MultiQuoteItemInfo multiQuoteItemInfo = (MultiQuoteItemInfo) this.m_hqClient.m_htItemInfo[(object) strArray2[index]];
        if (multiQuoteItemInfo != null && multiQuoteItemInfo.name.Length != 0 && !multiQuoteItems.Contains(strArray2[index]))
        {
          AddValue addValue = new AddValue(multiQuoteItemInfo.name, strArray2[index]);
          arrayList2.Add((object) addValue);
        }
      }
      if (arrayList2.Count != 0)
      {
        this.lbUseable.DataSource = (object) arrayList2;
        this.lbUseable.DisplayMember = "Display";
        this.lbUseable.ValueMember = "Value";
      }
      else
      {
        this.lbUseable.DisplayMember = (string) null;
        this.lbUseable.ValueMember = (string) null;
      }
      this.lbUseable.DataSource = (object) arrayList2;
    }
    ...
    private void initSetOther()
    {
      for (int index = 1; index <= 5; ++index)
        this.cbBuySell.Items.Add((object) index);
      ...
      string[] strArray = this.setInfo.MultiQuoteItems.Split(';');
      for (int index = 3; index < strArray.Length; ++index)
        this.cbMultiQuoteStaticIndex.Items.Add((object) index);
    ...
    private void butAddItem_Click(object sender, EventArgs e)
    {
      ...
      {
        int num = (int) MessageBox.Show("请选择可用列！");
      }
      else
      {
        ...
        if (selectedIndex <= -1)
          return;
        ArrayList arrayList1 = (ArrayList) this.lbUseable.DataSource;
        AddValue addValue = (AddValue) arrayList1[selectedIndex];
        ArrayList arrayList2 = (ArrayList) this.lbCurrentItems.DataSource;
        arrayList2.Add((object) addValue);
        arrayList1.RemoveAt(selectedIndex);
        this.lbUseable.DataSource = (object) null;
        this.lbCurrentItems.DataSource = (object) null;
        if (arrayList1.Count != 0)
        {
          this.lbUseable.DataSource = (object) arrayList1;
          this.lbUseable.DisplayMember = "Display";
          this.lbUseable.ValueMember = "Value";
        }
        else
        ...
        if (arrayList2.Count != 0)
        {
          this.lbCurrentItems.DataSource = (object) arrayList2;
          this.lbCurrentItems.DisplayMember = "Display";
          this.lbCurrentItems.ValueMember = "Value";
        }
        else
        ...
        else if (selectedIndex >= this.lbUseable.Items.Count)
    ...
    private void butDelItem_Click(object sender, EventArgs e)
    {
      ...
      {
        int num1 = (int) MessageBox.Show("请选择当前标题！");
      }
      else if (this.lbCurrentItems.Items.Count < 4)
      {
        int num2 = (int) MessageBox.Show("最少保留三列可用");
      }
      else
      {
        ...
        ArrayList arrayList1 = (ArrayList) this.lbUseable.DataSource;
        ArrayList arrayList2 = (ArrayList) this.lbCurrentItems.DataSource;
        AddValue addValue = (AddValue) arrayList2[selectedIndex];
        if (arrayList1 == null)
        ...
        else if (selectedIndex >= this.lbCurrentItems.Items.Count)
    ...
    private void butUp_Click(object sender, EventArgs e)
    {
      if (this.lbCurrentItems.SelectedIndex == -1)
      {
        int num = (int) MessageBox.Show("请选择当前标题！");
      }
      else
      {
        int selectedIndex = this.lbCurrentItems.SelectedIndex;
        ...
        AddValue addValue = (AddValue) arrayList[selectedIndex];
        arrayList[selectedIndex] = arrayList[selectedIndex - 1];
        arrayList[selectedIndex - 1] = (object) addValue;
        this.lbCurrentItems.DataSource = (object) null;
        if (arrayList.Count != 0)
        {
          this.lbCurrentItems.DataSource = (object) arrayList;
          this.lbCurrentItems.DisplayMember = "Display";
          this.lbCurrentItems.ValueMember = "Value";
        }
        else
    ...
    private void buttonApply_Click(object sender, EventArgs e)
    {
      ...
      if (this.userSetFlag.itemsFlag)
      {
        ...
        {
          AddValue addValue = (AddValue) arrayList[index];
          str = str + addValue.Value + ";";
        }
        this.setInfo.saveSetInfo("MultiQuoteItems", str);
        this.setInfo.MultiQuoteItems = str;
        if (this.m_hqClient.CurrentPage == 0)
        {
          this.m_hqForm.UserCommand("60");
          this.m_hqForm.Repaint();
    ...
    private void buttonConfirm_Click(object sender, EventArgs e)
    {
      if (this.buttonApply.Enabled)
        this.buttonApply_Click((object) null, (EventArgs) null);
      this.Close();
    }
