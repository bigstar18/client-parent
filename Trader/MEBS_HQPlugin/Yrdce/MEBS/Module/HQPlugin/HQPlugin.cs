...
// Assembly: MEBS_HQPlugin, Version=3.0.4.0Logger.wirte(MsgType.Warning, Culture=neutral, PublicKeyToken=null
...
namespace Gnnt.MEBS.Module.HQPlugin
{
  public class HQPlugin : IPlugin
  {
    ...
    public void Initialize()
    {
      ...
      {
        this.pluginConfigInfo = (PluginConfigInfo) this.myHost.HtConfigInfo[(object) this.myName];
    ...
    {
      this.pluginInfo.HQResourceManager = this.Host.MEBS_ResourceManager;
