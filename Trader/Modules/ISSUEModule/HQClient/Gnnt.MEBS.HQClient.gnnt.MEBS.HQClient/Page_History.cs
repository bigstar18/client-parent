...
namespace Gnnt.MEBS.HQClient.gnnt.MEBS.HQClient
{
	internal class Page_History : Page_Main
	{
		...
		public Page_History(Rectangle _rc, HQForm m_HQForm) : base(_rc, m_HQForm)
		{
			...
			{
				Logger.wirte(3, "Page_History异常：" + ex.Message);
			}
		}
		...
		public override void Paint(Graphics g, int v)
		{
			...
			{
				Logger.wirte(3, "Page_History-Paint异常：" + ex.Message);
			}
		}
		...
		protected override void Page_KeyDown(object sender, KeyEventArgs e)
		{
			try
			{
				...
				if (keyData != Keys.Return)
				{
					...
					case Keys.Right:
						...
						else if (this.m_iHighlightRow < this.m_iRows - 1)
						{
						...
						else if (this.m_iCurPage < this.m_iTotalPage - 1)
						{
							this.m_iCurPage++;
							this.m_iHighlightRow = (this.m_iHighlightCol = 0);
							flag = true;
					...
					case Keys.Down:
						...
						else if (this.m_iCurPage * (this.m_iRows * this.m_iCols) + (this.m_iHighlightRow + 1) * this.m_iCols + this.m_iHighlightCol <= this.m_aCode.Count - 1)
						{
							this.paintHighlight(this.m_iHighlightRow + 1, this.m_iHighlightCol);
						}
						break;
			...
			{
				Logger.wirte(3, "Page_History-Page_KeyDown异常：" + ex.Message);
			}
		}
		...
		protected override void contextMenu_ItemClicked(object sender, ToolStripItemClickedEventArgs e)
		{
			...
			{
				Logger.wirte(3, "Page_History-contextMenu_ItemClicked异常：" + ex.Message);
			}
		}
