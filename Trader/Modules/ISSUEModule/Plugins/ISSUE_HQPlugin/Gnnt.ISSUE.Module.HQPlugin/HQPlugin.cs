...
using TPME.Log;
namespace Gnnt.ISSUE.Module.HQPlugin
{
	public class HQPlugin : IPlugin
	{
		private int myPluginNO = 3;
		private string myName = "ISSUE_HQSystem";
		private string myConfigFileName = "ISSUE_HQPlugin.xml";
		private string mySettingConfigName = "ISSUE_HQSystems.xml";
		private Hashtable myHashConfigSettings = new Hashtable();
		private string myDescription = "投资品行情系统插件";
		...
		{
			this.pluginInfo.HQResourceManager = this.Host.get_ISSUE_ResourceManager();
