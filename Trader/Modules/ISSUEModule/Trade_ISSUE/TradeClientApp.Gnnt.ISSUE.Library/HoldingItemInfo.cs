...
namespace TradeClientApp.Gnnt.ISSUE.Library
{
	public class HoldingItemInfo
	{
		...
		{
			this.m_strItems = "CommodityID;TransactionsCode;BuyHolding;BuyAvg;SellHolding;SellAvg;Margin;Floatpl;BuyVHolding;SellVHolding;GoodsQty;NewPriceLP;Market;MarketValue";
			...
			this.m_htItemInfo.Add("CommodityName", new ColItemInfo(Global.M_ResourceManager.GetString("TradeStr_CommodityName"), 10, "", 0));
			this.m_htItemInfo.Add("TransactionsCode", new ColItemInfo(Global.M_ResourceManager.GetString("TradeStr_TransactionsCode"), 10, "", 0));
			this.m_htItemInfo.Add("BuyHolding", new ColItemInfo(Global.M_ResourceManager.GetString("TradeStr_BuyHolding"), 10, "", 0));
			...
			this.m_htItemInfo.Add("Margin", new ColItemInfo(Global.M_ResourceManager.GetString("TradeStr_Margin"), 7, Global.formatMoney, 0));
			...
			this.m_htItemInfo.Add("BuyVHolding", new ColItemInfo(Global.M_ResourceManager.GetString("TradeStr_BuyVHolding"), 9, "", 0));
			...
			this.m_htItemInfo.Add("LPRatio", new ColItemInfo(Global.M_ResourceManager.GetString("TradeStr_LPRatio"), 8, "", 0));
			this.m_htItemInfo.Add("MarketValue", new ColItemInfo(Global.M_ResourceManager.GetString("TradeStr_MV"), 7, Global.formatMoney, 0));
