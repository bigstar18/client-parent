...
namespace TradeClientApp.Gnnt.ISSUE.Library
{
	public class OrderItemInfo
	{
		...
		private void initAllItem()
		{
			...
			this.m_htItemInfo.Add("CommodityName", new ColItemInfo(Global.M_ResourceManager.GetString("TradeStr_CommodityName"), 7, "", 0));
			...
			this.m_htItemInfo.Add("Price", new ColItemInfo(Global.M_ResourceManager.GetString("TradeStr_Price"), 9, Global.formatMoney, 1));
			this.m_htItemInfo.Add("Qty", new ColItemInfo(Global.M_ResourceManager.GetString("TradeStr_Qty"), 8, "", 1));
			...
			this.m_htItemInfo.Add("Market", new ColItemInfo(Global.M_ResourceManager.GetString("TradeStr_MarKet"), 4, "", 1));
