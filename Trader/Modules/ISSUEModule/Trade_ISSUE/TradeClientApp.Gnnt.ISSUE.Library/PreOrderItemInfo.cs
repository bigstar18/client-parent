...
namespace TradeClientApp.Gnnt.ISSUE.Library
{
	public class PreOrderItemInfo
	{
		...
		{
			this.m_strItems = "SelectFlag;ID;TransactionsCode;CommodityCode;CommodityName;B_S;O_L;Price;Qty;MarKet;LPrice;TodayPosition;";
			...
			this.m_htItemInfo.Add("CommodityName", new ColItemInfo(Global.M_ResourceManager.GetString("TradeStr_CommodityName"), 11, "", 1));
			...
			this.m_htItemInfo.Add("LPrice", new ColItemInfo(Global.M_ResourceManager.GetString("TradeStr_ZDPrice"), 11, "", 0));
