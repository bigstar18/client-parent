...
namespace SysFrame.UI.Forms.PromptForms
{
	public class BalanceForm : Form
	{
		...
		private void BalanceForm_Load(object sender, EventArgs e)
		{
			...
			{
				Logger.wirte(3, base.Name + ex.ToString());
			}
		}
		private void SetControlText()
		{
			this.Text = Global.Modules.get_Plugins().get_MEBS_ResourceManager().GetString("TradeStr_BalanceForm_Form");
			this.btnNo.Text = Global.Modules.get_Plugins().get_MEBS_ResourceManager().GetString("TradeStr_BalanceForm_btnNo");
			this.btnYes.Text = Global.Modules.get_Plugins().get_MEBS_ResourceManager().GetString("TradeStr_BalanceForm_btnYes");
		}
	}
}
