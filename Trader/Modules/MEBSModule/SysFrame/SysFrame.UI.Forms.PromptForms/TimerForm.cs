...
namespace SysFrame.UI.Forms.PromptForms
{
	public class TimerForm : MyForm
	{
		...
		private void TimerForm_Load(object sender, EventArgs e)
		{
			...
			{
				Logger.wirte(1, ex.ToString());
			}
			this.timer_close.Start();
		}
		private void SetControlText()
		{
			this.Text = Global.Modules.get_Plugins().get_MEBS_ResourceManager().GetString("TradeStr_TimerForm_Form");
			this.btn_cancelclose.Text = Global.Modules.get_Plugins().get_MEBS_ResourceManager().GetString("TradeStr_TimerForm_btn_cancelclose");
			this.btn_cancelclose.TextAlign = ContentAlignment.MiddleCenter;
			this.btn_imclose.Text = Global.Modules.get_Plugins().get_MEBS_ResourceManager().GetString("TradeStr_TimerForm_btn_imclose");
			this.btn_imclose.TextAlign = ContentAlignment.MiddleCenter;
			this.lbl_message.Text = Global.Modules.get_Plugins().get_MEBS_ResourceManager().GetString("TradeStr_TimerForm_lbl_message");
		...
		private void SetSkin()
		{
			...
			this.btn_imclose.BackgroundImage = (Image)Global.Modules.get_Plugins().get_MEBS_ResourceManager().GetObject("TradeImg_Skin1");
			this.btn_cancelclose.BackgroundImage = (Image)Global.Modules.get_Plugins().get_MEBS_ResourceManager().GetObject("TradeImg_Skin1");
