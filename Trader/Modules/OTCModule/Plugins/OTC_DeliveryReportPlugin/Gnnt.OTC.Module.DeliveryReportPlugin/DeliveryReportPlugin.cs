...
namespace Gnnt.OTC.Module.DeliveryReportPlugin
{
	public class DeliveryReportPlugin : IPlugin
	{
		private int myPluginNO = 10;
		private string myName = "OTC_DeliveryReport";
		private string myConfigFileName = "OTC_DeliveryReport.xml";
		private string myDescription = "交割申报系统插件";
		...
		private string PreLoginUrl = "/tradeweb/report/navigator.jsp";
		private string LoginedUrl = "/tradeweb/report/navigator.jsp";
		...
		public void Initialize()
		{
			...
			{
				Logger.wirte(3, "报表系统插件xml文档格式不对 。");
			}
			...
			else
			{
				try
				{
					...
					if (responseVO != null && responseVO.RetCode == 0L)
					{
						result = true;
						info = "注销成功！";
						Logger.wirte(1, "ReportPlugin 注销成功");
					}
					else
					{
