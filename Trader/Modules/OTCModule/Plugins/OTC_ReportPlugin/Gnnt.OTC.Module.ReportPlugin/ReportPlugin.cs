...
namespace Gnnt.OTC.Module.ReportPlugin
{
	public class ReportPlugin : IPlugin
	{
		private int myPluginNO = 10;
		private string myName = "OTC_Report";
		private string myConfigFileName = "OTC_Report.xml";
		private string myDescription = "报表系统插件";
