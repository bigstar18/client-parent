...
namespace YrdceClient.UI.Forms.PromptForms
{
	public class ChangePW : MyForm
	{
		...
		{
			this.Text = Global.Modules.Plugins.MEBS_ResourceManager.GetString("TradeStr_ChangePW_Form");
            
			this.LabOldPW.Text = Global.Modules.Plugins.MEBS_ResourceManager.GetString("TradeStr_labOldPwd");
			this.labNewPW.Text = Global.Modules.Plugins.MEBS_ResourceManager.GetString("TradeStr_labNewPwd");
			this.labConfirmPW.Text = Global.Modules.Plugins.MEBS_ResourceManager.GetString("TradeStr_labConfirmPwd");
			this.buttonSubmit.Text = Global.Modules.Plugins.MEBS_ResourceManager.GetString("TradeStr_buttonSubmit");
			this.labelMessage.Visible = false;
			if (this.myForceChangePassword)
			{
				this.buttonSubmit.Location = new Point(120, 163);
				this.buttonCancel.Visible = false;
				return;
			}
			this.buttonCancel.Text = Global.Modules.Plugins.MEBS_ResourceManager.GetString("TradeStr_buttonCancel");
		}
		private void textNewPW_KeyPress(object sender, KeyPressEventArgs e)
		{
			if (!char.IsLetterOrDigit(e.KeyChar) && e.KeyChar != '\b')
			{
				string @string = Global.Modules.Plugins.MEBS_ResourceManager.GetString("TradeStr_ChangePW_OnlyNumLetter");
		...
		private void textNewPW_Leave(object sender, EventArgs e)
		{
			...
			if (flag)
			{
				...
				this.labelMessage.Text = Global.Modules.Plugins.MEBS_ResourceManager.GetString("TradeStr_ChangePW_Prompt");
				return;
			}
			this.labelMessage.Visible = false;
		}
