...
namespace YrdceClient.UI.Forms.PromptForms
{
	public class CommitForm : Form
	{
		...
		private void SetControlText()
		{
			...
			this.Text = Global.Modules.Plugins.MEBS_ResourceManager.GetString("TradeStr_COMMIT_CAPTION");
			this.buttonAgree.Text = Global.Modules.Plugins.MEBS_ResourceManager.GetString("TradeStr_BUTTON_AGREE");
			this.buttonUnAgree.Text = Global.Modules.Plugins.MEBS_ResourceManager.GetString("TradeStr_BUTTON_UNAGREE");
			this.labCommitment.Text = Global.Modules.Plugins.MEBS_ResourceManager.GetString("TradeStr_LAB_COMMITMENT");
			this.webBrowser.Visible = true;
			string text = string.Empty;
			this.htConfig = Global.Modules.Plugins.ConfigurationInfo.getSection("Systems");
		...
		private void buttonAgree_Click(object sender, EventArgs e)
		{
			...
			if (this.chbCommit.Checked)
			{
				if (this.CommitType == 0)
				{
					Global.Modules.Plugins.ConfigurationInfo.updateValue("Systems", "IsDisplayCommitday", DateTime.Now.Date.ToShortDateString());
					return;
				}
				Global.Modules.Plugins.ConfigurationInfo.updateValue("Systems", "IsDisplayCommit", "false");
			}
		}
