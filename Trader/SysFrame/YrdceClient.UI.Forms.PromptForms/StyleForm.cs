...
namespace YrdceClient.UI.Forms.PromptForms
{
	public class StyleForm : Form
	{
		...
		private void SetControlText()
		{
			...
			this.Text = Global.Modules.Plugins.MEBS_ResourceManager.GetString("StyleTitle");
			this.radioButtonAuto.Text = Global.Modules.Plugins.MEBS_ResourceManager.GetString("StyleRadioButtonAuto");
			this.radioButtonT1.Text = Global.Modules.Plugins.MEBS_ResourceManager.GetString("StyleradioButtonT1");
			this.radioButtonT8.Text = Global.Modules.Plugins.MEBS_ResourceManager.GetString("StyleradioButtonT8");
			this.buttonOK.Text = Global.Modules.Plugins.MEBS_ResourceManager.GetString("TradeStr_BUTTON_OK");
			this.buttonAuto.Text = Global.Modules.Plugins.MEBS_ResourceManager.GetString("TradeStr_BUTTON_CANCEL");
			int num = Tools.StrToInt((string)Global.Modules.Plugins.ConfigurationInfo.getSection("Systems")["FormStyle"], 0);
			if (num == 0)
			{
		...
		private void radioButtonAuto_CheckedChanged(object sender, EventArgs e)
		{
			...
			{
				this.pictureBoxStyle.Image = (Image)Global.Modules.Plugins.MEBS_ResourceManager.GetObject("T0");
			}
			if (this.radioButtonT1.Checked)
			{
				this.pictureBoxStyle.Image = (Image)Global.Modules.Plugins.MEBS_ResourceManager.GetObject("T1");
			}
			if (this.radioButtonT8.Checked)
			{
				this.pictureBoxStyle.Image = (Image)Global.Modules.Plugins.MEBS_ResourceManager.GetObject("T8");
			}
		}
		private void buttonOK_Click(object sender, EventArgs e)
		{
			if (Tools.StrToBool((string)Global.Modules.Plugins.ConfigurationInfo.getSection("Systems")["FirstRunApp"], false))
			{
				Global.Modules.Plugins.ConfigurationInfo.updateValue("Systems", "FirstRunApp", "false");
			}
			int num = Tools.StrToInt((string)Global.Modules.Plugins.ConfigurationInfo.getSection("Systems")["FormStyle"], 0);
			if ((num != 0 && this.radioButtonAuto.Checked) || (num != 1 && this.radioButtonT1.Checked) || (num != 8 && this.radioButtonT8.Checked))
			{
				...
				Global.Modules.Plugins.ConfigurationInfo.updateValue("Systems", "FormStyle", num.ToString());
