	...
	public class UpdateOperation
	{
		...
		private void CheckUpdate(object obj)
		{
			...
			if (checkForUpdate.StartCheck())
			{
				...
				{
					string @string = Global.Modules.Plugins.MEBS_ResourceManager.GetString("TradeStr_LoginForm_UpdateTitle");
					string string2 = Global.Modules.Plugins.MEBS_ResourceManager.GetString("TradeStr_LoginForm_UpdateContext");
