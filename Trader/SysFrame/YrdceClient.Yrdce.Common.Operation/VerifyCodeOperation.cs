...
namespace YrdceClient.Yrdce.Common.Operation
{
	public class VerifyCodeOperation
	{
		...
		{
			string @string = Global.Modules.Plugins.MEBS_ResourceManager.GetString("TradeStr_LoginForm_ErrorInfo");
			if (verifyUserInfo.username.Trim().Equals(""))
			{
				string string2 = Global.Modules.Plugins.MEBS_ResourceManager.GetString("TradeStr_LoginForm_inputId");
			...
			{
				string string3 = Global.Modules.Plugins.MEBS_ResourceManager.GetString("TradeStr_LoginForm_inputPassword");
			...
			{
				string string4 = Global.Modules.Plugins.MEBS_ResourceManager.GetString("TradeStr_LoginForm_inputVerifyCode");
			...
			{
				string string5 = Global.Modules.Plugins.MEBS_ResourceManager.GetString("TradeStr_LoginForm_VerifyCodeError");
				MessageBox.Show(string5, @string, MessageBoxButtons.OK, MessageBoxIcon.Hand);
				this.SetFocus(3);
				return;
			}
			bool flag = WinSendMessage.SendMessageByProcessName("YrdceClient", verifyUserInfo.username, handle);
			if (flag)
			{
				string string6 = Global.Modules.Plugins.MEBS_ResourceManager.GetString("TradeStr_LoginForm_Tip");
				string string7 = Global.Modules.Plugins.MEBS_ResourceManager.GetString("TradeStr_LoginForm_RepeatLogin");
			...
			Logger.wirte(MsgType.Information, "启动登陆线程");
			this.EnableControls(false, "null");
			UserInfo userInfo = new UserInfo();
			userInfo.UserID=verifyUserInfo.username;
			userInfo.PassWord=verifyUserInfo.password;
			userInfo.ModuleID="";
