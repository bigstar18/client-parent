...
/// </summary>
	public class StripButtonControl : UserControl
	{
		...
		public ToolStrip toolStripButtons;//主页面顶部菜单
		...
		private void SetToolStripButtons()
		{
			try
			{
                ...
                this.toolStripButtons.BackgroundImage = this.menuBackImage;//设置菜单栏背景
                this.toolStripButtons.OverflowButton.AutoSize = false;
				this.toolStripButtons.OverflowButton.Width = 30;
			}
			catch (Exception ex)
			{
				Logger.wirte(MsgType.Error, "初始化StripButtonControl异常：" + ex.Message);
			}
		}
		...
		public void ChangeItemCheckState(ToolStripItem toolstripitem)
		{
